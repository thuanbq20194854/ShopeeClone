      ...
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            ...
            renderPopover={
              <div className='relative cursor-pointer rounded-md border border-gray-200 bg-white  shadow-md'>
                <div className='flex flex-col  py-2 pl-3 pr-28'>
                  <div className='px3 py2 hover:text-orange'>Tiếng Việt</div>
                  <div className='px3 py2 mt-2 hover:text-orange'>English</div>
                </div>
              </div>
            }
          >
          ...
          {isAuthenticated && (
            ...
            >
              <div className='mr-2 h-6 w-6 flex-shrink-0'>
                <img
                  src='https://down-vn.img.susercontent.com/file/5940cd044f10fd299731fee453f74c07_tn'
                  alt='avatar'
            ...
            <Popover
              ...
              renderPopover={
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  <div className='p-2'>
                    <div className='capatilize text-gray-400'>Sản phẩm mới thêm</div>
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lf7wem1pcbbr74_tn'
                            alt='anh'
                            className='object-covere h-11 w-11'
                          />
                        </div>
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>
                            Sữa rửa mặt dành cho da mụn innisfree Bija Trouble Facial Foam 150g
                          </div>
                        </div>
