  ...
  const renderPagination = () => {
    ...
    return Array(pageSize)
      ...
      .map((_, index) => {
        ...
        /* Ta xét các TH render ra 3 chấm hoặc null */
        if (page <= RANGE * 2 + 1 && pageNumber > page + RANGE && pageNumber < pageSize - RANGE + 1) {
          /* TH1: chỉ có 1 dấu ba chấm nằm sau page hiện tại, page >=  */
          return renderDotAfter(index)
        } else if (page > RANGE * 2 + 1 && page < pageSize - RANGE * 2) {
          /* TH2: có 2 dấu 3 chấm trước và sau page hiện tại */
          ...
          /* chỉ có 1 dấu 3 chấm đăng trước page hiện tại, vì page >= pageSize - RANGE */
          return renderDotBefore(index)
        }

        /* TH còn lại render ra số trang */
        return (
          <Link
            to={{
              pathname: path.home,
